...
public class MyAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    @Override//this happens anyway and passes result to next method if everything went ok
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        //given by previously configured authmanager
        ...
        String refresh_token = JWT.create()
                ...
                .withExpiresAt(new Date(System.currentTimeMillis() + MINUTES_TO_EXPIRE_JWT_REFRESH * 60 * 1000))
                .withIssuer(request.getRequestURL().toString())
                .sign(algorithm);
